...
EXCEPT_MSG = """
    Pyperclip could not find a copy/paste mechanism for your systm.
...
def determine_clipboard():
    ...
    if 'cygwin' in platform.system().lower(): # Cygwin has a variety of values returned by platform.systm(), such as 'CYGWIN_NT-6.1'
...
def set_clipboard(clipboard):
    ...
    the copy() and paste() functions interact with the operating systm to
